#!/usr/bin/env bash
DOCKER_IMAGE_NAME=csra/camel-spring-docker
DOCKER_IMAGE_VERSION=latest

mvn clean package

docker rmi --force=true ${DOCKER_IMAGE_NAME}:${DOCKER_IMAGE_VERSION}
docker build --no-cache=true --force-rm=true -f Docker/Dockerfile --rm=true -t ${DOCKER_IMAGE_NAME}:${DOCKER_IMAGE_VERSION} .
echo =========================================================================
